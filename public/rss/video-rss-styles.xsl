    ...
    <html xmlns="http://www.w3.org/1999/xhtml" lang="en">
      ...
      <body>
        ...
        <div class="container-md px-3 py-3 markdown-body">
          ...
          <h2>My YouTube Videos So Far...</h2>
          ...
          <xsl:variable name="allContent" select="*[name()='content:encoded']" />
            <div class="py-5">
              ...
              📅 <xsl:value-of select="concat(substring($pubDate, 1, 2), ' ', substring($pubDate, 4, 3), ', ', substring(pubDate, 12, 5), ' (', substring(pubDate, 1, 3), ')')" /> • ⏱️ <xsl:value-of select="substring-before(substring-after($allContent, '&lt;p&gt;Duration: '), '&lt;&#47;p&gt;')" />
              </small>
            </div>
