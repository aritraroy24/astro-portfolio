...
export async function get(context) {
  ...
  return rss({
    ...
    description:
      "I'm a Theoretical Computational Chemist & Algorithm Enthusiast from India. If you subscribe to this RSS feed you will receive updates and summaries of my new posts about computational chemistry, programming and stuff.",
    site: context.site,
    author: "Aritra Roy",
    commentsUrl:
