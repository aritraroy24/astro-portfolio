...
<Button
    text="Download Code"
    href="../../../../assets/files/videos/gaussian/do-this-gaussian-16-linux-version-on-windows-10-or-11-using-wsl-in-15-minutes/g16_wsl.txt"
    customStyle="margin-bottom: 25px; text-decoration: none;"
    download="g16_wsl.txt"
/>
<Button
    text="Download Input Sample"
    href="../../../../assets/files/videos/gaussian/do-this-gaussian-16-linux-version-on-windows-10-or-11-using-wsl-in-15-minutes/input.gjf"
    customStyle="margin-bottom: 25px; text-decoration: none;"
    download="input.gjf"
/>